...
public class EstudoDAO {
    ...
    ArrayList<EstudoDTO> lista = new ArrayList<>(); 

    
    public void CadastrarPessoa(EstudoDTO objtestedto){
    ...
    public ArrayList <EstudoDTO> Pesquisarpessoa(){
    ...
    public void AtualizarPessoa(EstudoDTO objtestedto){
    ...
    public void DeletarPessoa(EstudoDTO objtestedto){
